...
#ifndef __APPLE__
  EXPECT_THAT(StringToIPAddressWithOptionalScope("bad-address%1"),
...
TEST(IPAddressTest, IPv6LinkLocal) {
  ...
  // deserialize an interface index or name is left as an exercise for the
  // application.
