...
using google::api::expr::v1::Expr;
using google::api::expr::v1::Constant;
using google::api::expr::v1::SourceInfo;
using testing::_;
using Ident = google::api::expr::v1::Expr::Ident;
using Select = google::api::expr::v1::Expr::Select;
using Call = google::api::expr::v1::Expr::Call;
using CreateList = google::api::expr::v1::Expr::CreateList;
using CreateStruct = google::api::expr::v1::Expr::CreateStruct;
using Comprehension = google::api::expr::v1::Expr::Comprehension;
