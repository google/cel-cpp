...
class SourcePositionTest : public testing::Test {
 protected:
  void SetUp() override {
    ...
    source_info_.mutable_line_offsets().push_back(0);
    source_info_.mutable_line_offsets().push_back(1);
    source_info_.mutable_line_offsets().push_back(2);
    (source_info_.mutable_positions())[1] = 2;
    source_info_.mutable_line_offsets().push_back(4);
    (source_info_.mutable_positions())[2] = 4;
    (source_info_.mutable_positions())[3] = 7;
    source_info_.mutable_line_offsets().push_back(9);
    source_info_.mutable_line_offsets().push_back(10);
...
TEST_F(SourcePositionTest, TestNoNewlines) {
  source_info_.mutable_line_offsets().clear();
