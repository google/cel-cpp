...
CelExpressionBuilderFlatImpl BuilderForEnumTest(absl::string_view container) {
  cel::RuntimeOptions options;
...
TEST(FlatExprBuilderTest, ShortEnumResolution) {
  ...
  CelExpressionBuilderFlatImpl builder =
      BuilderForEnumTest("google.api.expr.runtime.TestMessage");
...
TEST(FlatExprBuilderTest, EnumResolutionHonorsLeadingDot) {
  google::protobuf::Arena arena;
  CelExpressionBuilderFlatImpl builder =
      BuilderForEnumTest("google.api.expr.runtime");
...
TEST(FlatExprBuilderTest, FullEnumNameWithContainerResolution) {
  google::protobuf::Arena arena;
  CelExpressionBuilderFlatImpl builder =
      BuilderForEnumTest("very.random.Namespace");
...
TEST(FlatExprBuilderTest, PartialQualifiedEnumResolution) {
  google::protobuf::Arena arena;
  CelExpressionBuilderFlatImpl builder = BuilderForEnumTest("google.api.expr");
...
CelExpressionBuilderFlatImpl BuilderForNamespaceTest(
...
TEST(FlatExprBuilderTest, NameCollisionWithComprehensionVar) {
  google::protobuf::Arena arena;
  CelExpressionBuilderFlatImpl builder = BuilderForNamespaceTest("google");
...
TEST(FlatExprBuilderTest, NameCollisionWithComprehensionVarLeadingDot) {
  google::protobuf::Arena arena;
  CelExpressionBuilderFlatImpl builder = BuilderForEnumTest("google");
