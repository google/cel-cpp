...
#ifndef THIRD_PARTY_CEL_CPP_CHECKER_PROTO_TYPE_MASK_PROVIDER_H_
#define THIRD_PARTY_CEL_CPP_CHECKER_PROTO_TYPE_MASK_PROVIDER_H_
...
class ProtoTypeMaskProvider {
 public:
  static absl::StatusOr<std::unique_ptr<ProtoTypeMaskProvider>> Create(
  ...
  friend void AbslStringify(Sink& sink,
                            const ProtoTypeMaskProvider& proto_type_mask) {
    std::string new_line = "\n";
    std::string output = absl::StrCat(new_line, "ProtoTypeMaskProvider {");
    ...
    for (absl::string_view type_name :
      ...
      absl::StrAppend(&output, new_line, "{", new_line, " type: ", type_name,
                      new_line,
                      " visible fields: ", absl::StrJoin(visible_fields, ", "),
                      new_line, "}");
    }
 ...
 private:
  ...
  explicit ProtoTypeMaskProvider(
      absl::flat_hash_map<std::string, std::set<std::string>>
          types_and_visible_fields)
...
#endif  // THIRD_PARTY_CEL_CPP_CHECKER_PROTO_TYPE_MASK_PROVIDER_H_
