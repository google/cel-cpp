...
#ifndef THIRD_PARTY_CEL_CPP_COMMON_IPADDRESS_OSS_H_
...
class IPAddress {
 ...
 private:
  ...
  bool Equals6(const IPAddress& other) const {
    ...
    uint64_t a1 =
        common_internal::UnalignedLoad<uint64_t>(&addr_.addr6.s6_addr32[0]);
    uint64_t a2 =
        common_internal::UnalignedLoad<uint64_t>(&addr_.addr6.s6_addr32[2]);
    uint64_t b1 = common_internal::UnalignedLoad<uint64_t>(
        &other.addr_.addr6.s6_addr32[0]);
    uint64_t b2 = common_internal::UnalignedLoad<uint64_t>(
