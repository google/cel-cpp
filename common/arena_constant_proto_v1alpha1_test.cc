...
#include "common/arena_constant_proto_v1alpha1.h"
...
class ArenaConstantProtoV1Alpha1Test : public Test {
 public:
  void SetUp() override {
    arena_.emplace();
...
TEST_F(ArenaConstantProtoV1Alpha1Test, Bool) {
  ConstantProto expected_proto;
...
TEST_F(ArenaConstantProtoV1Alpha1Test, Int) {
  ConstantProto expected_proto;
...
TEST_F(ArenaConstantProtoV1Alpha1Test, Uint) {
  ConstantProto expected_proto;
...
TEST_F(ArenaConstantProtoV1Alpha1Test, Double) {
  ConstantProto expected_proto;
...
TEST_F(ArenaConstantProtoV1Alpha1Test, Bytes) {
  ConstantProto expected_proto;
...
TEST_F(ArenaConstantProtoV1Alpha1Test, String) {
  ConstantProto expected_proto;
...
TEST_F(ArenaConstantProtoV1Alpha1Test, Duration) {
  ConstantProto expected_proto;
  ASSERT_TRUE(google::protobuf::TextFormat::ParseFromString(
...
TEST_F(ArenaConstantProtoV1Alpha1Test, Timestamp) {
  ConstantProto expected_proto;
  ASSERT_TRUE(google::protobuf::TextFormat::ParseFromString(
