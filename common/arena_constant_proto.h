...
#ifndef THIRD_PARTY_CEL_CPP_COMMON_ARENA_CONSTANT_PROTO_H_
#define THIRD_PARTY_CEL_CPP_COMMON_ARENA_CONSTANT_PROTO_H_
...
absl::Status ArenaConstantToProto(
    const ArenaConstant& constant,
    absl::Nonnull<google::api::expr::v1alpha1::Constant*> proto);

}  // namespace cel

#endif  // THIRD_PARTY_CEL_CPP_COMMON_ARENA_CONSTANT_PROTO_H_
