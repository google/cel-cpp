...
INSTANTIATE_TEST_SUITE_P(
    ...
    ValuesIn<FormattingTestCase>({
        ...
        },
        {
            ...
            .expected = R"(["NaN", "Infinity", "-Infinity"])",
        },
        {
        ...
        },
        {
            ...
            .expected = "1.052033E+03",  // Different from Golang formatting.
            .locale = "en_US",
        },
        {
            .name = "LocaleSupport",
        ...
        },
        {
            ...
            .expected = "1h45m47s",  // Different from Golang (6347s) Could be
                                     // fixed by always printing in seconds.
        },
        {
        ...
        },
        {
            ...
            .format = "%s",
            .format_args =
                R"({"key1": b"xyz", "key5": null, "key2": duration("2h"), "key4": true, "key3": 2.71828})",
            .expected =
                R"({"key1":b"xyz", "key2":duration("2h"), "key3":2.71828, "key4":true, "key5":null})",
            .locale = "nl_NL",
        },
        {
        ...
        },
        {
            ...
            .dyn_args = {{"dynDuration", absl::Hours(2) + absl::Minutes(25) +
                                             absl::Seconds(47)}},
            .expected = "Dynamic Type Duration: 2h25m47s",
        },
        {
        ...
        },
        {
            ...
            .expected =
                "Infinity",  // Different from Golang (+Inf) consistent with the
                             // allowed input string for infinity.
        },
        {
            ...
            .format_args = R"(double("-Inf"))",
            .expected =
                "-Infinity",  // Different from Golang (-Inf) consistent with
                              // the allowed input string for infinity.
        },
        {
            ...
            .format_args = R"([double("NaN"), double("+Inf"), double("-Inf")])",
            .expected =
                R"(["NaN", "Infinity", "-Infinity"])",  // Different from Golang
                                                        // (-Inf) consistent
                                                        // with the allowed
                                                        // input string for
                                                        // infinity.
        },
        {
            ...
            .expected = "2ns",  // Different from Golang (0.000000002s).
        },
    }),
