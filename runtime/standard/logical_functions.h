...
#ifndef THIRD_PARTY_CEL_CPP_RUNTIME_LOGICAL_FUNCTIONS_H_
#define THIRD_PARTY_CEL_CPP_RUNTIME_LOGICAL_FUNCTIONS_H_
...
#endif  // THIRD_PARTY_CEL_CPP_RUNTIME_LOGICAL_FUNCTIONS_H_
